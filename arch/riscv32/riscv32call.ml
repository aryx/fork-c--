 ...
 * results; cutto} triple riscv32cc.ml's cc_specs table supplies.
 *
 ...
 * read that file's header comment for the general shape. See riscv32cc.ml's
...
(* claude: t0/x5 must NOT be in vol_int - riscv32rec.mlb's immediate-
 ...
 * pointer-chain reason documented in riscv32cc.ml's header comment (the
 * ARM r11 precedent). *)
