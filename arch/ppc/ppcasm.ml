...
(* Purpose *)
(*****************************************************************************)
(* A Linux/ELF-targeted sibling of ppcmach.ml, which emits upstream's original
 ...
 *
 * Read arch/ppc/ppcmach.ml first for the PPC-specific parts (32-bit
...
(* claude: unlike ppcmach.ml's Mach-O mangler, ELF C symbols on
...
object (this)
     ...
     * same convention ppcmach.ml uses for Mach-O - unlike x86asm.ml, where
