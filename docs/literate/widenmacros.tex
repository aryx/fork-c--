% claude: \inferrule/\TirName below (for the widening inference rules) come
% from mathpartir, which is not loaded elsewhere in this book.
...
\renewcommand{\f}{\ensuremath{\mathrm{f}}}
