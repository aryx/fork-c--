  ...
  module M (C : Lua.Lib.CORE with type 'a V.userdata' = 'a userdata') =
    struct
      ...
      let init g = 
        ...
        (*s: register modules to [[g]] in alphabetical order *)
        ...
        *)
        ...
        (*x: embedding/projection pairs for calling conventions *)
        ...
        (*e: embedding/projection pairs for calling conventions *)
        ...
        *)
        ...
        (*e: register modules to [[g]] in alphabetical order *)
        V.at_init g [ 
        (*s: lua initialization *)
        ...
        (*e: lua initialization *)
       ]
      (*e: export goodies to Lua *)
    end (*M*)
end (*MakeLib*)
(*e: Linking QC-- Types *)
